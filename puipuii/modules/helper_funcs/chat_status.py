...
from puipuii import (DEL_CMDS, DEV_USERS, SUDO_USERS,
                          SUPPORT_USERS, TIGER_USERS, WHITELIST_USERS,
                          dispatcher)
from puipuii.mwt import MWT
from telegram import Chat, ChatMember, ParseMode, Update
from puipuii.modules.helper_funcs.extraction import extract_user # needed
...
def user_admin(func):
    ...
    @wraps(func)
    def is_admin(update: Update, *args, **kwargs):
        bot = context.bot
        user = update.effective_user
        chat = update.effective_chat
...
from puipuii.modules import connection
