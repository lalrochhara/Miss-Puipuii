...
from puipuii import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, MESSAGE_DUMP, LOGGER
from puipuii.modules.helper_funcs.handlers import CMD_STARTERS
from puipuii.modules.helper_funcs.misc import is_module_loaded, send_to_list
from puipuii.modules.helper_funcs.chat_status import is_user_admin
from puipuii.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from puipuii.modules.helper_funcs.string_handling import markdown_parser
from puipuii.modules.disable import DisableAbleCommandHandler

import puipuii.modules.sql.feds_sql as sql
from puipuii.modules.helper_funcs.alternate import send_message
    ...
    if args:
        if args[0] == 'json':
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "puipuii_fbanned_users.json"
            ...
            with BytesIO(str.encode(backups)) as output:
                ...
                update.effective_message.reply_document(document=output, filename="puipuii_fbanned_users.csv",
