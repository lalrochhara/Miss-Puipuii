...
import puipuii.modules.sql.global_bans_sql as gban_sql
import puipuii.modules.sql.users_sql as user_sql
from puipuii import dispatcher, OWNER_ID, DEV_USERS
