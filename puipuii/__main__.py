...
from puipuii import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from puipuii.modules import ALL_MODULES
from puipuii import dispatcher
...
from puipuii.modules.helper_funcs.misc import paginate_modules
from puipuii.modules.translations.strings import tld
...
See [Basic Configuration Checklist](https://t.me/PuipuiiSupports/10) on how to secure your group.

See the Source code of this bot [Source Code](https://github.com/lalrochhara/duat)
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("puipuii.modules." + module_name)
